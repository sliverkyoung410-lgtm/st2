...
jQuery(document).ready(function() {
	...
	jQuery('.main_product_category .main_product_inner .main_product_tab li, .content_list .tabcontent').removeClass('active'); // 나머지 탭 숨김
	jQuery('.main_product_category .main_product_inner .main_product_tab li:first-child, .content_list .tabcontent:first-child').addClass('active'); // 첫번째 탭 오픈
